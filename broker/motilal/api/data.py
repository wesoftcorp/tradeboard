...
class BrokerData:
    ...
    def get_quotes(self, symbol: str, exchange: str) -> dict:
        ...
        try:
            ...
            # Map Tradeboard exchange to Motilal exchange
            ...
            # Return quote in Tradeboard common format
            return {
    ...
    def get_depth(self, symbol: str, exchange: str) -> dict:
        ...
        This follows the Tradeboard standard structure matching Angel and other brokers.
        ...
        try:
            ...
            # Create a normalized depth structure in the Tradeboard format
            ...
            # Return in Angel's Tradeboard standard format (matching lines 524-537 of angel/api/data.py)
            return {
                "bids": formatted_bids,
                "asks": formatted_asks,
                "high": high,
