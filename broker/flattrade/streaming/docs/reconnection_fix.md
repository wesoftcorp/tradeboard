...
This document outlines a critical session management issue identified with the Flattrade WebSocket API and the corresponding architectural fix implemented in the Tradeboard proxy.
...
5.  Restarting the main Tradeboard application would temporarily resolve the problem, allowing the next connection to succeed.
