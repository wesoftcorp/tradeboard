...
class IbullsExchangeMapper:
    """Maps between Tradeboard exchange codes and Ibulls XTS specific exchange types"""

    # Exchange type mapping for Ibulls XTS broker
    # Format: {Tradeboard_Exchange: iBulls_Exchange_Code}
    ...
    # Reverse mapping for converting iBulls exchange codes to Tradeboard format
    # Format: {iBulls_Exchange_Code: Tradeboard_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert Tradeboard exchange code to Ibulls XTS specific exchange type
    ...
    @staticmethod
    def get_Tradeboard_exchange(ibulls_code):
        """
        Convert Ibulls XTS exchange code to Tradeboard exchange code
