...
# Add upstream remote
git remote add upstream https://github.com/wesoftcorp/tradeboard.git
...
2. **Bug Fixes**
   - Check [issues labeled "good first issue"](https://github.com/wesoftcorp/tradeboard/labels/good%20first%20issue)
...
- **GitHub Discussions**: Ask questions in [GitHub Discussions](https://github.com/wesoftcorp/tradeboard/discussions)
- **Documentation**: Check [docs.wesoftcorp.com](https://docs.wesoftcorp.com)
- **GitHub Issues**: Report bugs in [Issues](https://github.com/wesoftcorp/tradeboard/issues)

### Before Asking for Help

1. **Search existing issues** — your question might already be answered
2. **Check documentation** — review docs at docs.wesoftcorp.com
...
- **Repository**: [github.com/wesoftcorp/tradeboard](https://github.com/wesoftcorp/tradeboard)
- **Issue Tracker**: [github.com/wesoftcorp/tradeboard/issues](https://github.com/wesoftcorp/tradeboard/issues)
