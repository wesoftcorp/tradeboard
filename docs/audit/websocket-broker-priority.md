...
**Companion to:** [`websocket-keepalive-audit.md`](./websocket-keepalive-audit.md) (transport/keepalive layer) and Issue [#1101 — Standard WebSocket Ping/Heartbeat](https://github.com/wesoftcorp/tradeboard/issues/1101).
...
- Issue [#1101 — Standard WebSocket Ping/Heartbeat](https://github.com/wesoftcorp/tradeboard/issues/1101)
