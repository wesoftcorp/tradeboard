...
API docs: <https://docs.TradeBoard.in/api-documentation/v1/orders-api/placegttorder>
...
```
GET https://docs.TradeBoard.in/change-log/release/version-2.0.0.8-released.md?ask=<question>
```
