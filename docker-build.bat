...
docker-compose exec -T Tradeboard python -c "import numba; import llvmlite; import scipy; print('SUCCESS')" 2>nul | findstr "SUCCESS" >nul
if %ERRORLEVEL% EQU 0 (
...
docker-compose exec -T Tradeboard python -c "from scipy import stats; print('SUCCESS' if abs(stats.norm.cdf(0) - 0.5) ^< 0.001 else 'FAILED')" 2>nul | findstr "SUCCESS" >nul
if %ERRORLEVEL% EQU 0 (
