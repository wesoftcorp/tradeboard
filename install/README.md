...
# Or using curl
curl -O https://raw.githubusercontent.com/wesoftcorp/tradeboard/main/install/install.sh
...
- Check the [GitHub repository](https://github.com/wesoftcorp/tradeboard)
