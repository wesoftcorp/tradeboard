...
DEFAULT_REPO="https://github.com/wesoftcorp/tradeboard.git"
...
for i in "${!CONF_DOMAINS[@]}"; do
    ...
    if [ "$IS_UPDATE_MODE" == "true" ] && [ -f "$ENV_FILE" ]; then
        ...
        # See: https://github.com/marketcalls/Tradeboard/issues/938
        ...
        # not found." See https://github.com/marketcalls/Tradeboard/issues/960.
        chmod 644 "$ENV_FILE"
