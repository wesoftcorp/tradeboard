...
Anyone with the TradeBoard.db file AND the API_KEY_PEPPER + FERNET_SALT (i.e.
...
# Tables live in the main TradeBoard.db by default. DATABASE_URL is whatever
        ...
        return [
            {
                ...
                "TradeBoard_username": u.TradeBoard_username,
